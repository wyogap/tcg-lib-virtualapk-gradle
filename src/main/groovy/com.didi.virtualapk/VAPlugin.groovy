...
//        }
    ...
    private void checkConfig() {
        ...
        if (projectOptions.get(BooleanOption.ENABLE_DEX_ARCHIVE)) {
            throw new InvalidUserDataException("VAPlugin: Can't using incremental dexing mode, please add 'android.useDexArchive=false' in gradle.properties of :${project.name}.")
        }
